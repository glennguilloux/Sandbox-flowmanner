...
class TestToolCatalogModels:
    ...
    def test_tool_has_required_columns(self):
        ...
        required = {"id", "slug", "name", "description", "category", "tool_type",
                     "handler_ref", "input_schema", "output_schema", "enabled",
                     "version", "source", "tags", "tier"}
    ...
    def test_capability_has_required_columns(self):
        ...
        required = {"id", "slug", "name", "description", "category",
                     "handler_ref", "input_schema", "output_schema",
