...
class TestLocalWhisper:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_local_success(self, transcriber, tiny_audio_b64,
                                             mock_whisper_model):
        with patch(
    ...
    @pytest.mark.asyncio
    async def test_transcribe_local_json_format(self, transcriber, tiny_audio_b64,
                                                  mock_whisper_model):
        with patch(
            "app.tools.speech_to_text_transcriber._get_local_whisper",
            return_value=mock_whisper_model,
    ...
    @pytest.mark.asyncio
    async def test_transcribe_local_text_format(self, transcriber, tiny_audio_b64,
                                                  mock_whisper_model):
        with patch(
            "app.tools.speech_to_text_transcriber._get_local_whisper",
            return_value=mock_whisper_model,
    ...
    @pytest.mark.asyncio
    async def test_transcribe_local_with_language(self, transcriber, tiny_audio_b64,
                                                    mock_whisper_model):
        with patch(
            "app.tools.speech_to_text_transcriber._get_local_whisper",
            return_value=mock_whisper_model,
    ...
    @pytest.mark.asyncio
    async def test_transcribe_local_with_prompt(self, transcriber, tiny_audio_b64,
                                                  mock_whisper_model):
        with patch(
            "app.tools.speech_to_text_transcriber._get_local_whisper",
            return_value=mock_whisper_model,
    ...
    @pytest.mark.asyncio
    async def test_transcribe_local_tempfile_cleaned(self, transcriber, tiny_audio_b64,
                                                       mock_whisper_model):
...
class TestOpenAIAPIPath:
    ...
    async def test_transcribe_api_success(self, transcriber, tiny_audio_b64):
        ...
        mock_response.json.return_value = {
            ...
            "duration": 2.0,
            "segments": [
                {"start": 0.0, "end": 2.0, "text": "hello from api",
                 "confidence": 0.98},
            ],
        }
    ...
    @pytest.mark.asyncio
    async def test_no_api_key_no_local_fallback_error(self, transcriber,
                                                        tiny_audio_b64):
