...
class TestCheckAllProvidersHealth:
    ...
    async def test_health_check_all_providers(self):
        with patch("app.services.llm_router.PROVIDER_MAP", {"openai": ("https://api.openai.com", "OPENAI_API_KEY")}), \
            ...
            mock_resolve.return_value = ("https://api.openai.com", "sk-test", "gpt-4")
            mock_client = AsyncMock()
