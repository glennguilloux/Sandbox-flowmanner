...
- Track trending topic velocity on Weibo's hot search and SuperTopic boards; log which content types and posting windows achieve hot search entry at which engagement thresholds
- Maintain a brand reputation monitoring log — record all negative keyword spikes, crisis trigger events, and response effectiveness scores for post-incident learning
- Record KOL/KOC performance data: cost per post, average engagement rate, fan overlap with target audience, and conversion rate for each partnership
- Monitor Weibo algorithm and ad product changes (Fensi Tong targeting updates, Super Topic traffic mechanics) and update content and paid distribution strategies accordingly
...
- **Hot Search Engineering**: Construct coordinated post + comment + repost waves using KOL seeding and fan community activation to accelerate brand topics toward Weibo's hot search ranking within 2-hour windows
- **SuperTopic Community Architecture**: Build and operate branded SuperTopics as loyalty hubs — structured content calendars, moderator playbooks, and fan engagement rituals that sustain daily active member counts
- **Crisis Response Playbook**: Pre-write tiered response templates for product complaints, misinformation spread, and social media pile-ons; activate within 30 minutes of any severity-1 brand mention spike
- **Weibo Commerce Integration**: Link Weibo product cards, brand flagship stores, and limited-edition drops to coordinated hot topic campaigns that convert social engagement into direct Taobao/JD purchase traffic
