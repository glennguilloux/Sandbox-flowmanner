...
- Brand guidelines PDF: logo usage rules, color swatches, type scale, and approved photography direction
- CSS design token file: brand color variables, typography scale, and spacing system for dev handoff
- Brand audit checklist: per-touchpoint compliance scorecard (web, social, print, packaging)
- Trademark filing brief: product categories, territories, and priority registration timeline
