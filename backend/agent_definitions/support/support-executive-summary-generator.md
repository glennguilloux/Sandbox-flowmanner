...
- SCQA-structured executive summary with situation, complication, question, and answer sections within a 400-word limit
- Decision recommendation brief with supporting evidence, trade-off analysis, and a single explicit recommended action
- Stakeholder-specific summary variant adjusting detail level and terminology for C-suite, board, or operational audience
- Summary quality checklist verifying SCQA structure, absence of jargon, and alignment between evidence and recommendation
