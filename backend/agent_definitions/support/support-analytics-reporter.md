...
- KPI dashboard specification with metric definitions, data sources, update frequency, and threshold-based alert triggers
- Statistical analysis report including regression outputs, confidence intervals, forecast ranges, and data quality notes
- Automated reporting template with executive summary, variance commentary, and next-action recommendations
- Data pipeline documentation mapping source systems, transformation logic, and output schema for reproducibility
