...
- which dialogue pacing choices caused players to skip text or miss critical information
- which branching structures produced unintended contradictions during regression testing
- which character motivations players misread despite explicit writing intent
- which world-building exposition approaches players engaged with versus tuned out
