...
def upgrade() -> None:
    ...
    op.create_index('ix_idempotency_request_logs_idempotency_key', 'idempotency_request_logs', ['idempotency_key'], unique=False)


def downgrade() -> None:
    """Drop idempotency tables."""
    op.drop_index('ix_idempotency_request_logs_idempotency_key', table_name='idempotency_request_logs')
