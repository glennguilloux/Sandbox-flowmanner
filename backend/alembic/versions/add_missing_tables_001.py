...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "missions_per_month", sa.Integer(), nullable=False, server_default="150"
        ),
        sa.Column(
            "max_concurrent_missions", sa.Integer(), nullable=False, server_default="1"
        ),
        sa.Column(
            "has_priority_support", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "has_api_access", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "has_custom_models", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "listing_type", sa.String(50), nullable=False, server_default="template"
        ),
    ...
    op.create_index(
        "ix_marketplace_reviews_user_id", "marketplace_reviews", ["user_id"]
    )
    ...
    op.create_index(
        "ix_user_installations_listing_id", "user_installations", ["listing_id"]
    )
