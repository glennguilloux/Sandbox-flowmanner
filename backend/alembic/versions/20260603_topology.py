...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source", sa.String(50), server_default="computed",
            comment="'computed', 'imported', 'manual'",
        ),
        sa.Column(
            "snapshot_data", postgresql.JSONB(), nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "node_type", sa.String(100), nullable=True,
            comment="'agent', 'capability', 'workflow', 'tool', etc.",
        ),
        sa.Column("community_id", sa.Integer(), nullable=True),
        sa.Column("metadata", postgresql.JSONB(), nullable=True),
        sa.Column(
            "derived_from_agent_id", sa.String(36), nullable=True,
            comment="FK to agents.id",
        ),
        sa.Column(
            "derived_from_capability_id", sa.String(36), nullable=True,
            comment="FK to capabilities_catalog.id",
        ),
        sa.Column(
            "derived_from_workflow_id", sa.String(36), nullable=True,
    ...
    op.create_table(
        ...
        sa.Column(
            "relation", sa.String(100), server_default="calls",
            comment="'calls', 'depends-on', 'data-flow', etc.",
        ),
        sa.Column(
            "confidence", sa.String(50), server_default="INFERRED",
