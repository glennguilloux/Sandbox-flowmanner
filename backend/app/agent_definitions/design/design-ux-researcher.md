...
- Research study plan: objectives, methodology selection rationale, participant screener, consent forms
- Usability test report: task completion rates, error rates, think-aloud transcripts, severity-ranked findings
- User journey map: touchpoint-level friction scores, emotional highs/lows, opportunity annotations
- Insight synthesis deck: affinity diagram, top 5 prioritized findings with supporting evidence and design recommendations
