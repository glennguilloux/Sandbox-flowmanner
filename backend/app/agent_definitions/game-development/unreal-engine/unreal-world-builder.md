...
- which World Partition cell sizes caused streaming hitches during fast traversal
- which landscape layer configurations exceeded mobile shader complexity budgets
- which PCG graph designs produced deterministic results versus seed-dependent variation
- which foliage density settings caused LOD pop-in visible during normal gameplay camera speeds
