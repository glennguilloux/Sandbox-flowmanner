...
- which Editor GUI patterns caused slow inspector redraws on large serialized objects
- which AssetPostprocessor rules produced false positives that frustrated artists
- which asmdef boundaries caught real dependency violations versus added unnecessary friction
- which CI validation failures were consistently actionable versus environment noise
