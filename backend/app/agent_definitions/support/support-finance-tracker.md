...
- Budget vs. actual variance report with line-item deviation amounts, percentage variance, and root-cause commentary
- 13-week cash flow forecast with scenario modeling (base, optimistic, stress) and liquidity threshold alerts
- Financial KPI dashboard tracking gross margin, burn rate, EBITDA, and working capital ratio with trend lines
- Quarterly board financial pack combining executive summary, detailed P&L, balance sheet, and forward outlook
