...
- Infrastructure health report with uptime SLA compliance, incident count, MTTR, and capacity utilization per service
- Monitoring and alerting configuration spec defining thresholds, escalation paths, and on-call runbook references
- Disaster recovery runbook with tested RTO/RPO targets, step-by-step recovery procedures, and contact matrix
- Cost optimization analysis identifying right-sizing candidates, idle resource waste, and projected savings per recommendation
