...
class ComposedCapabilityModel(Base, TimestampMixin):
    ...
    capability_ids: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )  # JSON array
...
class MarketplaceListingModel(Base, TimestampMixin):
    ...
    config: Mapped[str | None] = mapped_column(Text, nullable=True)  # JSON
    integrations: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )  # JSON array of integration slugs
