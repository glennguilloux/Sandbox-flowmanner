...
class SubscriptionTier(Base, TimestampMixin):
    ...
    missions_per_month: Mapped[int] = mapped_column(Integer, default=150, nullable=False)
    ...
    has_custom_models: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
...
class UserSubscription(Base, TimestampMixin):
    ...
    tier_id: Mapped[int] = mapped_column(ForeignKey("subscription_tiers.id"), nullable=False)
