...
class OIDCProvider(Base, UUIDMixin, TimestampMixin):
    ...
    client_secret: Mapped[str] = mapped_column(String(500), nullable=False, comment="App-layer encrypted")
    scopes: Mapped[str | None] = mapped_column(String(500), nullable=True, default="openid email profile")
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)

    # relationships
    user_accounts: Mapped[list["UserOIDCAccount"]] = relationship(back_populates="provider", lazy="selectin")
...
class UserOIDCAccount(Base, UUIDMixin):
    ...
    subject: Mapped[str] = mapped_column(String(500), nullable=False, comment="OIDC 'sub' claim")
    ...
    # relationships
    provider: Mapped["OIDCProvider"] = relationship(back_populates="user_accounts", lazy="selectin")
...
class CustomRole(Base, UUIDMixin, TimestampMixin):
    ...
    delegations: Mapped[list["RoleDelegation"]] = relationship(back_populates="role", lazy="selectin")
