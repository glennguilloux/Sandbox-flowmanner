...
class User(Base, TimestampMixin):
    ...
    is_partner_admin: Mapped[bool] = mapped_column(
    ...
    onboarding_step: Mapped[str | None] = mapped_column(
        String(50), nullable=True, default="welcome"
    )
    ...
    onboarding_data: Mapped[str | None] = mapped_column(
    ...
    # Onboarding emails
    onboarding_emails: Mapped[list[OnboardingEmail]] = relationship(
        "OnboardingEmail", back_populates="user", cascade="all, delete-orphan"
    )
