    ...
    templates = [
        {
            ...
            "category": "general",
            "capabilities": ["text_generation", "conversation", "summarization", "question_answering", "translation"],
            "default_config": {
                "model": "qwen2.5:14b",
                "temperature": 0.7,
                "max_tokens": 2048,
        ...
        },
        {
            ...
            "category": "general",
            "capabilities": ["text_generation", "conversation", "summarization", "question_answering", "translation", "sentiment_analysis", "classification"],
            "default_config": {
                "model": "gpt-4",
                "temperature": 0.7,
                "max_tokens": 4096,
        ...
        },
        {
            ...
            "category": "coding",
            "capabilities": ["code_review", "code_generation", "problem_solving", "classification"],
            "default_config": {
                "model": "gpt-4",
                "temperature": 0.2,
                "max_tokens": 4096,
        ...
        },
        {
            ...
            "category": "vision",
            "capabilities": ["image_analysis", "visual_qa", "object_detection", "ocr", "classification"],
            "default_config": {
        ...
        },
        {
            ...
            "category": "reasoning",
            "capabilities": ["logical_reasoning", "problem_solving", "math", "planning"],
            "default_config": {
                "model": "qwen2.5:14b",
                "temperature": 0.2,
                "max_tokens": 2048,
        ...
        },
        {
            ...
            "category": "reasoning",
            "capabilities": ["logical_reasoning", "problem_solving", "decision_making", "planning", "math", "entity_extraction"],
            "default_config": {
                "model": "o1-preview",
                "temperature": 0.3,
                "max_tokens": 4096,
