...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('namespace_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('memory_namespaces.id'), nullable=True),
    ...
    op.create_table(
        'memory_associations',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('source_memory_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('agent_memories.id', ondelete='CASCADE'), nullable=False),
        sa.Column('target_memory_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('agent_memories.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_table(
        'memory_search_index',
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column('memory_id', postgresql.UUID(as_uuid=True), sa.ForeignKey('agent_memories.id', ondelete='CASCADE'), unique=True, nullable=False),
    ...
    op.create_index('ix_memory_search_keywords', 'memory_search_index', ['keywords'], postgresql_using='gin')
