...
def upgrade():
    ...
    op.create_index('idx_branches_parent_thread', 'chat_thread_branches', ['parent_thread_id'], unique=False)
    ...
    op.create_index('idx_model_sessions_session_id', 'chat_model_sessions', ['session_id'], unique=True)
    ...
    op.create_index('idx_context_settings_setting_id', 'context_settings', ['setting_id'], unique=True)
    ...
    op.create_index('idx_voice_transcription_id', 'voice_transcriptions', ['transcription_id'], unique=True)
