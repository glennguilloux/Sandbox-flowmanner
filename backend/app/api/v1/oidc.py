...
async def oidc_login(
    ...
    try:
        ...
        logger.error(f"Failed to initiate OIDC login for {provider}: {e}")
...
async def oidc_logout(
    ...
    try:
        ...
        logger.error(f"OIDC logout failed: {e}", exc_info=True)
...
async def oidc_refresh(
    ...
    try:
        ...
        logger.error(f"OIDC token refresh failed: {e}", exc_info=True)
