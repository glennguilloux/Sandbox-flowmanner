...
class PendingFix:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "recommendation": self.recommendation.to_dict() if hasattr(self.recommendation, 'to_dict') else self.recommendation,
    ...
    async def process_error(
        ...
        try:
            ...
            if recommendation.auto_applicable and self.auto_apply_enabled:
                ...
                logger.info(f"Fix {pending_fix.fix_id} requires human approval (confidence: {recommendation.confidence})")
