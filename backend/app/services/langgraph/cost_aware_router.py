...
class CostAwareRouter:
    ...
    DEFAULT_MODEL_COSTS = {
        ...
        "llamacpp-qwen2.5-coder-7b": ModelCosts(0, 0, is_local=True, quality_score=0.75, speed_score=0.9, max_context=8192),
        "llamacpp-qwen2.5-1.5b": ModelCosts(0, 0, is_local=True, quality_score=0.65, speed_score=0.95, max_context=4096),
        
        # DeepSeek (low cost)
        "deepseek-reasoner": ModelCosts(0.55, 2.19, is_local=False, quality_score=0.90, speed_score=0.6, max_context=128000),
        "deepseek-chat": ModelCosts(0.14, 0.28, is_local=False, quality_score=0.85, speed_score=0.8, max_context=128000),
        
        # Free cloud models
        "openrouter-gemma-2-9b-free": ModelCosts(0, 0, is_local=True, quality_score=0.70, speed_score=0.8, max_context=8192),
        
        # Paid models (when allowed)
        "claude-3-5-sonnet": ModelCosts(3.0, 15.0, is_local=False, quality_score=0.95, speed_score=0.7, max_context=200000),
        "claude-3-haiku": ModelCosts(0.25, 1.25, is_local=False, quality_score=0.85, speed_score=0.9, max_context=200000),
        "openrouter-gpt-4o": ModelCosts(2.5, 10.0, is_local=False, quality_score=0.93, speed_score=0.7, max_context=128000),
        "openrouter-gemini-2.0-flash": ModelCosts(0.075, 0.30, is_local=False, quality_score=0.88, speed_score=0.9, max_context=1000000),
    }
    ...
    def select_model(
        ...
        if force_model:
            ...
            return RoutingDecision(
                ...
                fallback_chain=self.routing_config.get(complexity, {}).get("fallback_chain", []),
