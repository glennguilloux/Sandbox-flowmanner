    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            try:
                ...
                # GraphInterpreter was intentionally removed (commit 1f4df6ec,
                # "dead code"). Until a real execution engine is wired, fail the
                # execution with an explicit message instead of crashing or hanging.
                await fail_execution(
                    db,
                    execution_id,
                    "graph execution engine retired (app.services.graph_executor removed in 1f4df6ec)",
                )
                return
