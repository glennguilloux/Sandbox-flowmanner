...
class QueryUnderstandingService:
    ...
    async def _expand_query(self, query: str, intent: SearchIntent, 
    ...
    def _check_time_sensitivity(self, query: str, 
                                 entities: list[ExtractedEntity]) -> bool:
        """Check if query is time-sensitive"""
        time_keywords = ['latest', 'recent', 'today', 'now', 'current', 'new',
                        'breaking', 'update', '2024', '2025', '2026']
    ...
    def _check_location_sensitivity(self, query: str,
                                     entities: list[ExtractedEntity]) -> bool:
        """Check if query is location-sensitive"""
        location_keywords = ['near', 'nearby', 'local', 'closest', 'in my area',
                           'around me', 'here']
    ...
    def _calculate_complexity(self, query: str, entities: list[ExtractedEntity],
