...
| `browser_navigate` | `_handle_browser` | `params` (O) |
| `browser_snapshot` | `_handle_browser` | `params` (O) |
| `browser_click` | `_handle_browser` | `params` (O) |
| `browser_type` | `_handle_browser` | `params` (O) |
| `browser_scroll` | `_handle_browser` | `params` (O) |
...
| `filter` | `_handle_transform` | `transformExpression` (O), `transformType` (O) |
...
| `llm_eval` | `_handle_llm` | `context_query` (O), `context_token_budget` (O), `long_context` (O), `max_tokens` (O), `prompt` (O), `system_prompt` (O), `temperature` (O) |
