...
from ...models.oidc_login_request import OIDCLoginRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v3/auth/oidc/{provider}/login".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        provider (str):
        body (OIDCLoginRequest): POST /auth/oidc/{provider}/login — initiate OIDC login flow.
