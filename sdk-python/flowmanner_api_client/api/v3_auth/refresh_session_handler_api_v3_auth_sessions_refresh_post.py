...
from ...models.refresh_session_request import RefreshSessionRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: None | RefreshSessionRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v3/auth/sessions/refresh",
    }

    if isinstance(body, RefreshSessionRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (None | RefreshSessionRequest | Unset):
