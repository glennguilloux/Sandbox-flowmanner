...
from ...models.program_update import ProgramUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v2/programs/{program_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        program_id (UUID):
        body (ProgramUpdate): Request body for ``PATCH /programs/{id}`` — PATCH semantics.
