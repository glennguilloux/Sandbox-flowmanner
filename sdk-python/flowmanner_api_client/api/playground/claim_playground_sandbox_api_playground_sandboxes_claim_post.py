...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/playground/sandboxes/claim",
    }
...
) -> ClaimResponse | HTTPValidationError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClaimResponse | HTTPValidationError]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ClaimResponse | HTTPValidationError
    """
