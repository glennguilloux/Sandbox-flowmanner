...
T = TypeVar("T", bound="FeedbackPatternUpdate")



@_attrs_define
class FeedbackPatternUpdate:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feedback_pattern_update = cls(
            status=status,
            suggested_fix=suggested_fix,
        )


        feedback_pattern_update.additional_properties = d
        return feedback_pattern_update
