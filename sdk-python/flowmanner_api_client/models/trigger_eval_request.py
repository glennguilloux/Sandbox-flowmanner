...
T = TypeVar("T", bound="TriggerEvalRequest")


@_attrs_define
class TriggerEvalRequest:
    """
    Attributes:
        dataset_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trigger_eval_request.additional_properties = d
        return trigger_eval_request
