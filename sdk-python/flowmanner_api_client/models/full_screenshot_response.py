...
T = TypeVar("T", bound="FullScreenshotResponse")


@_attrs_define
class FullScreenshotResponse:
    """
    Attributes:
        success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        full_screenshot_response.additional_properties = d
        return full_screenshot_response
