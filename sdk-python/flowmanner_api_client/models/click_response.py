...
class ClickResponse:
    ...
    clicked_at: ClickResponseClickedAtType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        clicked_at: dict[str, Any] | None | Unset
        if isinstance(self.clicked_at, Unset):
            clicked_at = UNSET
        elif isinstance(self.clicked_at, ClickResponseClickedAtType0):
            clicked_at = self.clicked_at.to_dict()
        else:
