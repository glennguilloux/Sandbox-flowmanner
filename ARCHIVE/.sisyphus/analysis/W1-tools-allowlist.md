...
**Grounding:** `/opt/flowmapper/backend` (real path: `/opt/flowmanner/backend`) — verified against live code, not the brief's assertions.
...
- **Path:** `/opt/flowmapper/docs/DUAL-WRITE-DECISION.md` (real: `/opt/flowmanner/docs/DUAL-WRITE-DECISION.md`).
